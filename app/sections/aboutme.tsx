        ...
        <section id="aboutme" className="min-h-screen scroll-mt-10 bg-gray-900 py-20 px-4">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <p className="max-w-xl text-lg text-gray-300 mx-auto mb-12 text-center">
                    Jmenuji se Jakub Váňa a jsem nadšenec do IT. Zajímám se o kybernetickou bezpečnost, také o programování především v Python a Java. Mám zkušenosti s vývojem aplikací, linuxem, sítěmi, atd. Rád se učím nové technologie.
                </p>
